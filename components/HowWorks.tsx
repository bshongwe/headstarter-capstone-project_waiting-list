...
const features: FeatureProps[] = [
    ...
    },
    {
        ...
        title: "Community",
        description:
            "Join a thriving community of users who share honest feedback about our product. Engage with reviews, ask questions, and contribute your own experiences to help others make informed decisions",
    },
    {
        icon: (
        ...
        title: "Scalability",
        description:
            "Bunny-AI Assistant grows with you. As our user base expands, our AI algorithms continuously improve, providing you with more accurate and personalized recommendations based on an ever-increasing pool of data",
    },
    {
        icon: (
    ...
    return (
        ...
        >
            ...
            <p className="md:w-3/4 mx-auto mt-4 mb-8 text-xl text-muted-foreground">
                Explore the features that make our app a must-have!
            </p>
