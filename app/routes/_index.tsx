...
export const meta: MetaFunction = () => {
    return [
        { title: 'Bunny-AI' },
        {
            name: 'description',
            content:
                'Streamline operations and boost productivity with our innovative SaaS solutions. Unlock the power of seamless workflows and data-driven decisions. Experience growth with Bunny-AI."',
        },
        {
            name: 'keywords',
            content:
